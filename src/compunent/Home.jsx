...
function Home() {
  ...
  return (
    <div>
      ...
      <CNavbar colorScheme="primary" className="bg-primary">
  <CContainer fluid>
   
  <CNavbarBrand href="#" className="text-light">  Weather</CNavbarBrand>
    <CForm className="d-flex justify-content-center">
      <CFormInput type="text" className="me-2" placeholder="Search" onChange={(e)=>City(e)} />
      <CButton type="button" color="warning"   onClick={()=>search()}>
        Search
      </CButton>
    </CForm>
  </CContainer>
